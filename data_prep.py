# In this script we examine the datasets and after cleaning them by keeping only the relevant features
# we merge the two datasets and save resulting dataset to a csv file.
import pandas as pd
